  ...
  <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
      ...
      <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
        <div className="col-span-2">
          ...
          {/* <div class="footer-logo "> */}
                            <a href="/" 
                            ><img src="https://www.erthpot.com/wp-content/uploads/2022/10/retina-01.png" className="w-[150px]  rounded-lg" alt="logo" /></a>
                        {/* </div> */}
        ...
        <div className="col-span-2 sm:col-span-1">
          ...
          <ul className="mt-6 space-y-4 text-sm">
            <li>
              <a href="#" className="text-gray-700 transition hover:opacity-75"> Partner With Us </a>
            </li>

            <li>
              <a href="#" className="text-gray-700 transition hover:opacity-75"> Registration </a>
            </li>

            <li>
              <a href="#" className="text-gray-700 transition hover:opacity-75"> Warranty Form </a>
            </li>
        ...
        <div className="col-span-2 sm:col-span-1">
          ...
          <ul className="mt-6 space-y-4 text-sm">
            ...
            <li>
              <a href="#" className="text-gray-700 transition hover:opacity-75"> Case & Studies </a>
            </li>
          </ul>
        </div>
    ...
    <div className="mt-8 border-t border-gray-100 pt-8">
      <div className="sm:flex sm:justify-between">
        <p className="text-xs text-gray-500">&copy;  Website Proudly Developed SocialNinjaz Technologies & Creative Media.</p>
